...
# read csv data
data = pd.read_csv("./public/rainfall-dataset.csv")
...
print("This is X-Train Data After Imputation")
print (X)

print("\n")
print("\n")

print("This is Y-Train Data After Imputation")
print(Y)

# End of Imputation

# start of the model structuring.
